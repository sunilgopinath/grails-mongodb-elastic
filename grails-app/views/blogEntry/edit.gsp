...
<html>
	...
	<body>
		<a href="#edit-blogEntry" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-blogEntry" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" onclick="filInDate()"/>
